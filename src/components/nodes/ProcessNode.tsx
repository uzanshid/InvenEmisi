...
const ProcessNode: React.FC<NodeProps<ProcessNodeData>> = ({ id, data, selected }) => {
    ...
    return (
        <div
            className={`min-w-[220px] rounded-lg border-2 shadow-lg ${isCircular
        ...
        >
            ...
            <div className={`px-3 py-2 rounded-t-md ${isCircular ? 'bg-red-500' : hasError ? 'bg-orange-500' : 'bg-purple-500'
                ...
                <input
                    ...
                    className="w-full bg-transparent text-white font-semibold text-sm text-center outline-none placeholder-purple-200"
